/* Generated By:JJTree&JavaCC: Do not edit this line. JJTJavaParserConstants.java */
package ua.gradsoft.parsers.java5.jjt;

public interface JJTJavaParserConstants {
  ...
  int GT = 125;
  int TYPE_DECLARATION_PLACEHOLDER = 126;
  int BLOCK_PLACEHOLDER = 127;
  int EXPRESSION_PLACEHOLDER = 128;
  int IDENTIFIER_PLACEHOLDER = 129;
