...
public class JavaCheckerTask extends Task {
    ...
    private void executeFork() throws BuildException
    {
      ...
      classpath.createPathElement().setPath(jchhome_+File.separator+"lib"+File.separator+"JavaChecker-2.5.0p7.jar");
      classpath.createPathElement().setPath(jchhome_+File.separator+"lib"+File.separator+"JavaChecker2Annotations-2.5.0p7.jar");
      classpath.createPathElement().setPath(jchhome_+File.separator+"lib"+File.separator+"TermWareJPP-1.1.2.jar");
