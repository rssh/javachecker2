    ...
    implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    /**
     * The number of valid components in this <tt>ZVector</tt> object. 
    ...
    /** rssh: changed fo ZVector **/
    private static final long serialVersionUID = -2767605614448989439L;
     ...
     *               is negative
     */
    public ZVector(int initialCapacity, int capacityIncrement) {
	super();
     ...
     *               is negative
     */
    public ZVector(int initialCapacity) {
     ...
     * @since   1.2
     */
    public ZVector(Collection<? extends E> c) {
        elementCount = c.size();
        // 10% for growth
	...
	try {
	    ZVector<E> v = (ZVector<E>) super.clone();
